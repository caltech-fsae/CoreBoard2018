...
void initialize_state_machine(statemachine *sm)
{
	    ...
	    add_tuple(sm, WAIT_HEARTBEATS, E_RST_FLT,              RST_FAULT,    &RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_BPPC_FLT,             RST_FAULT,    &BPPC_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_NO_RST_FLT,           NO_RST_FAULT, &NO_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_IMD_FLT,              NO_RST_FAULT, &IMD_NO_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_BSPD_FLT,             NO_RST_FAULT, &BSPD_NO_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_APPS_FLT,             NO_RST_FAULT, &APPS_NO_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_BSE_FLT,              NO_RST_FAULT, &BSE_NO_RST);
	    add_tuple(sm, WAIT_HEARTBEATS, E_AMS_FLT,              NO_RST_FAULT, &BMS_NO_RST);
